{{-- Caratteri del portale pubblico, ospitati sul nostro server.
     ...
     (OFL-Inter.txt nella stessa cartella).
     ...
     Una sola famiglia, Inter, in tondo e corsivo (decisione committente
     14/09/2026): il registro e' quello di un atto dell'ente, e un carattere
     da rivista - il Fraunces delle prime versioni - diceva l'opposto. Il
     corsivo non si lascia disegnare al browser: serve ai nomi botanici, che
     per convenzione si scrivono cosi', e un corsivo finto li sporca. --}}
@font-face {
    font-family: 'Inter';
    font-style: normal;
    font-weight: 300 700;
