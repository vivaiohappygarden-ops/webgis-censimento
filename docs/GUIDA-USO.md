...
Nella vista **Preventivi** della pagina Lavori si prepara un'offerta per un cliente:
lavorazioni dal catalogo (o voci scritte libere) con quantità e prezzi indicati a mano,
totale con IVA e **PDF pronto da inviare**.
Il flusso è bozza, inviato, accettato o rifiutato: un preventivo accettato
